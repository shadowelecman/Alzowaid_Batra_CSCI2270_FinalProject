...
/* 1-search for a movie by its year/genres/Actor/language/country using the same algorithm as the print !
2-add a comic cone panel cities where you find the shortest path from ones city to the comic cone && the shortest path if one wanted to go to all
3- search within a given range
4-find assignment 11 solution!
5- a chart or a balance?
6-include 2 classes or just 1 ?
7-sold out & profits ?
*/
